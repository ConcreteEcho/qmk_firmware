...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_3,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
               KC_4,    KC_5,    KC_6,    KC_7,    KC_8,               KC_END,  KC_0,   KC_ENT,  KC_PLUS, KC_EQL,
                                          KC_9,    QK_BOOT,            QK_BOOT, KC_DEL
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,             _______, _______, _______, _______, _______, KC_VOLD,
                 _______, _______, _______, _______, _______,             _______, _______, _______,  KC_EQL, _______,
                                            _______, _______,             _______, _______
    )
};
